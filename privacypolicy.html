...
<body>
    ...
    <nav>
        ...
        <div class="rowDivide">
            <div class="logo">
                <a href="index.html"><img src="assets/images/logomain.png" alt=""></a>
            </div>
            <div class="links">
                <ul>
            ...
            <div class="loginSignup">
                <a href="signup.html" id="primaryBtn">Sign in</a>
                <a href="signup.html" id="secondaryBtn">create a free account</a>
            </div>
    ...
    <section class="sideNav" id="sideNav">
        <ul>
            ...
            <li><a href="signup.html">Create a free account</a></li>
        </ul>
    </section>
    ...
    <div class="policy">
        <div class="rowWrapper">
            <h1>Privacy Policy for imail</h1>

            <p>At imail, accessible from www.imail.com, one of our main priorities is the privacy of our visitors. This
                Privacy Policy document contains types of information that is collected and recorded by imail and how we
                use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in imail. This policy is not applicable to
            ...
            <p>imail follows a standard procedure of using log files. These files log visitors when they visit websites.
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of imail.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on imail, which are sent directly to
            ...
            <p>Note that imail has no access to or control over these cookies that are used by third-party advertisers.
            </p>

            <h2>Third Party Privacy Policies</h2>

            <p>imail's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>imail does not knowingly collect any Personal Identifiable Information from children under the age of 13.
    ...
    <section class="footer">
        <div class="rowDivide">
            <div class="logo">
                <a href="index.html"> ©2022 iMail.&nbsp; All rights reserved</a>
            </div>
