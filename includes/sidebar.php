    ...
    <div class="modal-content">
        ...
        <form action="./sendmail.php" method="post" enctype="multipart/form-data">
            ...
            <div class="w3-section">
                ...
                <input type="submit" name="btnSend" value="Send Mail" class="w3-btn w3-right w3-dark-grey">
                <input type="submit" name="btnSave" value="Save Mail" class="w3-btn w3-right w3-green" style="margin-right:20px;">
            </div>
